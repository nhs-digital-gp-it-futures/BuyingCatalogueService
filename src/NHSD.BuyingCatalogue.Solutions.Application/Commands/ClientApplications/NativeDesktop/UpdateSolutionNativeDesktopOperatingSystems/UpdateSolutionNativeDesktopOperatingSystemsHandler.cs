...
namespace NHSD.BuyingCatalogue.Solutions.Application.Commands.ClientApplications.NativeDesktop.UpdateSolutionNativeDesktopOperatingSystems
{
    ...
    {
        public UpdateSolutionNativeDesktopOperatingSystemsHandler(
            IExecutor<UpdateSolutionNativeDesktopOperatingSystemsCommand> executor,
            IValidator<UpdateSolutionNativeDesktopOperatingSystemsCommand, ISimpleResult> validator)
