...
namespace NHSD.BuyingCatalogue.Solutions.Application.Commands.ClientApplications.NativeDesktop.UpdateSolutionNativeDesktopThirdParty
{
    ...
    {
        public UpdateSolutionNativeDesktopThirdPartyHandler(
            IExecutor<UpdateSolutionNativeDesktopThirdPartyCommand> executor,
            IValidator<UpdateSolutionNativeDesktopThirdPartyCommand, ISimpleResult> validator)
