...
namespace NHSD.BuyingCatalogue.Solutions.Application.Commands.ClientApplications.NativeMobile.UpdateSolutionMobileThirdParty
{
    ...
    {
        public UpdateSolutionMobileThirdPartyHandler(
            IExecutor<UpdateSolutionMobileThirdPartyCommand> executor,
            IValidator<UpdateSolutionMobileThirdPartyCommand, ISimpleResult> validator)
