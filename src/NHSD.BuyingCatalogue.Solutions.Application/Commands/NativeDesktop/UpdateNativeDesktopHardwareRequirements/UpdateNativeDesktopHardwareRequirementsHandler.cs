...
namespace NHSD.BuyingCatalogue.Solutions.Application.Commands.NativeDesktop.UpdateNativeDesktopHardwareRequirements
{
    ...
    {
        public UpdateNativeDesktopHardwareRequirementsHandler(IExecutor<UpdateNativeDesktopHardwareRequirementsCommand> executor,
            IValidator<UpdateNativeDesktopHardwareRequirementsCommand, ISimpleResult> validator) : base(executor, validator)
        {
        }
    }
}
