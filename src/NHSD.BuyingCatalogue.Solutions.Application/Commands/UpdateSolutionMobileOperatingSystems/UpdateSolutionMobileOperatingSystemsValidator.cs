...
{
    internal class UpdateSolutionMobileOperatingSystemsValidator : IValidator<UpdateSolutionMobileOperatingSystemsCommand, RequiredMaxLengthResult>
    {
        public RequiredMaxLengthResult Validate(UpdateSolutionMobileOperatingSystemsCommand command) =>
