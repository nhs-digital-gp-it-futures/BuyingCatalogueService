...
('C46E2', 'Automatically record which Patients have had COVID-19 vaccination invites created', @capabilityId, 1, 1),
('C46E3', 'View whether Patients have had a COVID-19 vaccination invite communication created', @capabilityId, 1, 1),
('C46E4', 'Automatically bulk send booking reminders to Patients via SMS messages for COVID-19 vaccination invites', @capabilityId, 1, 1),
...
('C46E12', 'Book COVID-19 vaccination appointments for eligible Patients registered across different GP Practices', @capabilityId, 3, 1),
...
('C46E23', 'Record that a COVID-19 vaccination appointment for a Patient has been completed', @capabilityId, 3, 1),
...
('C46E28', 'Extract COVID-19 vaccination appointments data for NHS Digital', @capabilityId, 3, 1),
