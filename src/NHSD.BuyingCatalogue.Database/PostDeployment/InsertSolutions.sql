...
TPP maintain close contact with staff at the unit throughout these phases to ensure an efficient and accurate implementation.',
    ...
    BEGIN
     INSERT INTO [dbo].[CataloguePrice]
          ...
          ('100004-001',	2, 1, '8BF9C2F9-2FD7-4A29-8406-3C6B7B2E5D65', 1, 'EUR', @now, 10101.65),
          ...
          ('100003-001', 2, 1, 'D43C661A-0587-45E1-B315-5E5091D6E9D0', 1, 'EUR', @now, 19.987),
          ('100007-001', 3, 1, 'F8D06518-1A20-4FBA-B369-AB583F9FA8C0', NULL, 'USD', @now, 49.95)
          ;
