...
namespace NHSD.BuyingCatalogue.Solutions.Persistence.Repositories
{
    ...
    {
        private const string GetSupplierBySolutionIdSql = @"
            SELECT ci.CatalogueItemId as SolutionId,
                   s.[Name],
                   s.Summary,
        ...
        private const string UpdateSupplierBySolutionIdSql = @"
            UPDATE s
               SET Summary = @Summary,
        ...
        private const string GetSuppliersByNameSql = @"
            SELECT s.Id, s.[Name]
              FROM dbo.Supplier AS s
        ...
        private const string GetSupplierByIdSql = @"
        ...
        {
            return (await dbConnector.QueryAsync<SolutionSupplierResult>(
                GetSupplierBySolutionIdSql,
                cancellationToken,
