...
namespace NHSD.BuyingCatalogue.Infrastructure
{
    ...
    {
        public static bool? ToBoolean(this string candidate) => candidate?.ToUpperInvariant() switch
        {
            "YES" => true,
            "NO" => false,
            _ => null,
        ...
        public static string NullIfWhitespace(this string candidate) => string.IsNullOrWhiteSpace(candidate)
            ? null
            : candidate;
