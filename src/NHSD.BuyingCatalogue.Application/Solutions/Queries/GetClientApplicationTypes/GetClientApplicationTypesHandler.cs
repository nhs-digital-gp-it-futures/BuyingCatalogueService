...
namespace NHSD.BuyingCatalogue.Application.Solutions.Queries.GetClientApplicationTypes
{
    ...
    /// </summary>
    internal sealed class GetClientApplicationTypesHandler : IRequestHandler<GetClientApplicationTypesQuery, GetClientApplicationTypesResult>
    {
        ...
        /// </summary>
        public GetClientApplicationTypesHandler(SolutionReader solutionReader, IMapper mapper)
        {
