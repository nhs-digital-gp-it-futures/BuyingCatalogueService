...
namespace NHSD.BuyingCatalogue.API.ViewModels
{
    ...
    public class SolutionDashboardSections
    {
        ...
        /// </summary>
        public SolutionDashboardSections(Solution solution)
        {
            if (solution is null)
            {
                throw new ArgumentNullException(nameof(solution));
    ...
    public class ClientApplicationTypesSubSections
    {
        ...
        public ClientApplicationTypesSubSections(ClientApplication clientApplication)
        {
        ...
        private bool IsBrowserBasedComplete(ClientApplication clientApplication)
        {
