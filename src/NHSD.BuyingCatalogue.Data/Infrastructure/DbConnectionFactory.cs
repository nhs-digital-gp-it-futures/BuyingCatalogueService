    ...
    internal sealed class DbConnectionFactory : IDbConnectionFactory
    {
        ...
        public async Task<IDbConnection> GetAsync(CancellationToken cancellationToken, DbConnectionStringBuilder connectionStringBuilder)
        {
            ...
            connection.ConnectionString =
                "Server=tcp:gpitfutures-sqlpri-dev.database.windows.net,1433;Initial Catalog=gpitfutures-db-dev;Persist Security Info=False;User ID=gpitfutureadmin;Password=6vygJRq9RhZy5knQw3WqkhPsPm77sujp;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
