...
Background:
    ...
    And Solutions exist
        ...
        | Sln6       | MedicOnline      | Sup 1      |                                | Another Desc    | { "ClientApplicationTypes": ["browser-based"],"BrowsersSupported" : ["Firefox"], "MobileResponsive": true, "Plugins": { "Required": false } } |
...
Scenario: 2. Solution not found
    Given a Solution Sln7 does not exist
    When a request is made to submit Solution Sln7 for review
