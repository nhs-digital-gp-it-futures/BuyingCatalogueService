...
Background:
    ...
    And CataloguePrice exists
        ...
        | Sln3            | Flat                   | OnDemand             | USD          | 567.321 | 8BF9C2F9-2FD7-4A29-8406-3C6B7B2E5D65 | Year         |                       |
        ...
        | Sln1-001A001    | Flat                   | Patient              | GBP          | 199.999 | F8D06518-1A20-4FBA-B369-AB583F9FA8C0 | Month        |                       |
...
@7264
Scenario: Get prices returns all prices
    ...
    And Prices are returned
        ...
        | Flat   | OnDemand         | USD          | 567.321 | licence         | per licence            | licences            | year         | per year            |
        ...
        | Flat   | Patient          | GBP          | 199.999 | patient         | per patient            | patients            | month        | per month           |

@7264
Scenario: Get a single Flat Price
...
@7264
Scenario: Get a single Tiered Price
...
@7264
Scenario: Get a list of flat prices
...
@7264
Scenario: Get a list of Tiered prices
...
@7264
Scenario: Get a list of flat and tiered prices
...
@7264
Scenario: Get a single Flat Price for an additional service
...
@7264
Scenario: Get prices with a catalogue item ID that doesn't exist
