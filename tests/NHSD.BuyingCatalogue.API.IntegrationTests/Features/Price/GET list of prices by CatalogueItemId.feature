Feature: GET a list of prices from a Catalogue Item ID
    As a Public User
    I want to be able to retrieve the price for a catalogue item
...
Scenario: 1. Get a single Flat Price
	When a GET request is made to retrieve the pricing for catalogue item with ID Sln1
...
Scenario: 2. Get a single Tiered Price
	When a GET request is made to retrieve the pricing for catalogue item with ID Sln2
	Then a successful response is returned
	And Prices are returned
...
Scenario: 3. Get a list of flat prices
	When a GET request is made to retrieve the pricing for catalogue item with ID Sln3
	Then a successful response is returned
	And Prices are returned
		| Type | ProvisioningType | CurrencyCode | Price  | PricingItemName | PricingItemDescription | PricingItemTierName | TimeUnitName | TimeUnitDescription |
...
Scenario: 4. Get a list of Tiered prices
	When a GET request is made to retrieve the pricing for catalogue item with ID Sln4
	Then a successful response is returned
	And Prices are returned
		| Type   | ProvisioningType | CurrencyCode | PricingItemName | PricingItemDescription | PricingItemTierName | TimeUnitName | TimeUnitDescription |
...
Scenario: 5. Get a list of flat and tiered prices
	When a GET request is made to retrieve the pricing for catalogue item with ID Sln5
	Then a successful response is returned
	And Prices are returned
		| Type   | ProvisioningType | CurrencyCode | Price  | PricingItemName | PricingItemDescription | PricingItemTierName | TimeUnitName | TimeUnitDescription |
...
@7264
Scenario: 6. Get a single Flat Price for an additional service
	When a GET request is made to retrieve the pricing for catalogue item with ID Sln1-001A001
	Then a successful response is returned
	And Prices are returned
		| Type | ProvisioningType | CurrencyCode | Price  | PricingItemName | PricingItemDescription | PricingItemTierName | TimeUnitName | TimeUnitDescription |
...
@7264
Scenario: 7. Get a price with no solution
	When a GET request is made to retrieve the pricing for catalogue item with ID INVALID
