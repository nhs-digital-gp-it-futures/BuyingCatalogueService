...
Scenario: 1. Browser Support is updated for the solution
    Given MarketingDetail exist
        ...
        | Sln1     | { "ClientApplicationTypes": [],"BrowsersSupported" : [ "IE8", "Opera" ], "MobileResponsive": false } |
        | Sln3     |                                                                                                      |
    ...
    And MarketingDetail exist
        | Solution | ClientApplication                                                                                    |
        | Sln1     | { "ClientApplicationTypes": [],"BrowsersSupported" : [ "Chrome", "Edge" ], "MobileResponsive": true} |
        | Sln3     |                                                                                                      |
        | Sln5     | {"MobileResponsive": false }                                                                         |  
...
Scenario: 2. Browser Support is added to the solution
   ...
   When a PUT request is made to update solution Sln2 browsers-supported section
         | BrowsersSupported   | MobileResponsive |
         | Chrome, Opera, Edge | yes              |
   Then a successful response is returned
   And MarketingDetail exist
        | Solution | ClientApplication                                                                                             |
        | Sln1     | { "ClientApplicationTypes": [],"BrowsersSupported" : [ "IE8", "Opera" ], "MobileResponsive": false   }        |
        | Sln2     | { "ClientApplicationTypes": [],"BrowsersSupported" : [ "Chrome", "Opera", "Edge" ], "MobileResponsive": true} |
        | Sln3     |                                                                                                               |
        | Sln5     | {"MobileResponsive": false }                                                                                  |
...
Scenario: 3. Browser Support is completely cleared
    Given MarketingDetail exist
        | Solution | ClientApplication                                                                                   |
        | Sln1     | { "ClientApplicationTypes": [],"BrowsersSupported" : [ "IE8", "Opera" ], "MobileResponsive": true } |
        | Sln3     |                                                                                                     |
        | Sln5     | {"MobileResponsive": false }                                                                        |
    When a PUT request is made to update solution Sln1 browsers-supported section
        | BrowsersSupported | MobileResponsive |
...
Scenario: 4. Empty Supported-Browsers is added to the solution, Mobile-Response is added
    Given MarketingDetail exist
        | Solution | ClientApplication                                                                                                                    |
        | Sln1     | { "ClientApplicationTypes": ["browser-based", "native-desktop"],"BrowsersSupported" : [ "IE8", "Opera" ], "MobileResponsive": true } |
        | Sln3     |                                                                                                                                      |
        | Sln5     | {"MobileResponsive": false }                                                                                                         |
    When a PUT request is made to update solution Sln1 browsers-supported section
        | BrowsersSupported | MobileResponsive |
    ...
    And MarketingDetail exist
        | Solution | ClientApplication                                                                                                      |
        | Sln1     | { "ClientApplicationTypes": ["browser-based", "native-desktop"], "BrowsersSupported" : [], "MobileResponsive": false } |
        | Sln3     |                                                                                                                        |
        | Sln5     | {"MobileResponsive": false }                                                                                           |
...
Scenario: 5. Supported-Browsers are added to the solution, Mobile-Response is empty
    ...
    And MarketingDetail exist
        | Solution | ClientApplication                                                                                                                                 |
        | Sln1     | { "ClientApplicationTypes": ["browser-based", "native-desktop"],"BrowsersSupported" : ["Firefox", "Chrome", "Safari"], "MobileResponsive": null } |
        | Sln3     |                                                                                                                                                   |
        | Sln5     | {"MobileResponsive": false }                                                                                                                      |
