...
Scenario: 1. Browser Additional Information is updated
    ...
    When a PUT request is made to update solution Sln1 browser-additional-information section
...
Scenario: 2. Solution is not found
    ...
    When a PUT request is made to update solution Sln2 browser-additional-information section
       | AdditionalInformation |
       | New Additional Info   |
