...
@3601
Scenario: Browser Additional Information are retreived for the solution
...
@3601
Scenario: Browser Additional Information are retrieved for the solution where no solutiondetail exists
...
@3601
Scenario: Browser Additional Information are retrieved for the solution where there is no additional information
