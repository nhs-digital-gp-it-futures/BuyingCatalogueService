...
Scenario: 1. Connection and Resolution details are retreived for the solution
    ...
    When a GET request is made for connectivity-and-resolution for solution Sln1
...
Scenario: 3. Solution not found
    ...
    When a GET request is made for connectivity-and-resolution for solution Sln4
...
Scenario: 5. Solution id not present in request
    When a GET request is made for connectivity-and-resolution with no solution id
