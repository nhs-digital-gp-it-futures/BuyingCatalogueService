...
@3608
Scenario: Components length is greater than 500 chars, capabilities is valid
...
@3608
Scenario: Components is valid, Capabilities length is greater than 500 chars
    When a PUT request is made to update the native-mobile-third-party section for solution Sln1
        | ThirdPartyComponents | DeviceCapabilities          |
...
@3608
Scenario: Components & Capabilities length is greater than 500 chars
    When a PUT request is made to update the native-mobile-third-party section for solution Sln1
       | ThirdPartyComponents        | DeviceCapabilities          |
