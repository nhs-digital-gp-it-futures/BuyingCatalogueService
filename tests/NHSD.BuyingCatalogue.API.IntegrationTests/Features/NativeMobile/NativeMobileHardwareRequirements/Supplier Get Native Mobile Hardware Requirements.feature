...
@3609
Scenario: Native Mobile Hardware Requirements are retrieved for the solution where no hardware requirements exist
...
@3609
Scenario: Native Mobile Hardware Requirements are retrieved for the solution where no solution detail exists
