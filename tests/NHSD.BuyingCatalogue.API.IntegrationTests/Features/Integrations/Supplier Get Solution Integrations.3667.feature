Feature:  Display Marketing Page Form Solution Integrations Section
    ...
    @3667
    Scenario: 1. Solution Integrations is retrieved for the solution
    ...
    @3667
    Scenario: 2. Solution Integrations is retrieved empty for the solution where no solution detail exists
