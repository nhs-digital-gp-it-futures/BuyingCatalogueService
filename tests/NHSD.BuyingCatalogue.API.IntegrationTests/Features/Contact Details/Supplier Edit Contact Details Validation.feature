...
@3966
Scenario: LastName exceeds the character length
    When a PUT request is made for solution Sln1 contact details
        | FirstName | LastName                   | Email       | PhoneNumber  | Department |
...
@3966
Scenario: Email exceeds the character length
    When a PUT request is made for solution Sln1 contact details
        | FirstName | LastName   | Email                       | PhoneNumber  | Department |
...
@3966
Scenario: PhoneNumber exceeds the character length
    When a PUT request is made for solution Sln1 contact details
        | FirstName | LastName   | Email       | PhoneNumber                 | Department |
...
@3966
Scenario: Department name exceeds the character length
    When a PUT request is made for solution Sln1 contact details
        | FirstName | LastName   | Email       | PhoneNumber  | Department                 |
...
@3966
Scenario: FirstName, LastName, Email, PhoneNumber and Department name exceeds the character length
