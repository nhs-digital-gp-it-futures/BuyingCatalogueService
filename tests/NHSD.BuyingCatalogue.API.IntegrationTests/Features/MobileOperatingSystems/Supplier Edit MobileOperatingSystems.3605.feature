...
Scenario: 1. Mobile Operating Systems is updated
    ...
    And SolutionDetail exist
        | Solution | SummaryDescription             | FullDescription   | ClientApplication                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
        | Sln1     | An full online medicine system | Online medicine 1 | {"ClientApplicationTypes": ["browser-based"],"BrowsersSupported" : [ "IE8", "Opera" ], "MobileResponsive": false, "Plugins" : {"Required" : true, "AdditionalInformation": "orem ipsum"}, "MinimumConnectionSpeed": null, "MinimumDesktopResolution": null, "HardwareRequirements": "Hardware Information",  "AdditionalInformation": "Some more info", "MobileFirstDesign": true, "NativeMobileFirstDesign": null, "MobileOperatingSystems": { "OperatingSystems": ["Linux", "Windows"], "OperatingSystemsDescription": "Added Linux" }, "MobileConnectionDetails": null, "MemoryAndStorage": null } |

@3605
Scenario: 2. Solution is not found
    Given a Solution Sln2 does not exist
    When a PUT request is made to update the mobile-operating-systems section for solution Sln2
      | OperatingSystems | OperatingSystemsDescription |
      | Linux            | Added Linux                 |
...
Scenario: 4. Solution id is not present in the request
    When a PUT request is made to update the mobile-operating-systems section with no solution id
       | OperatingSystems | OperatingSystemsDescription |
       | Linux, Windows   | Added Linux                 |
