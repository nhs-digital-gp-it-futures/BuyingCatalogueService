Feature: Display Marketing Page Preview Solution About Supplier Section
    ...
    Background:
        ...
        And Suppliers exist
            ...
            | Sup 2 | Supplier 2   | Drs. Inc         |                    | supplier-url2 |
            | Sup 3 | Supplier 3   | Org 3            | Supplier summary 3 |               |
            | Sup 4 | Supplier 4   | Org 4            | Supplier summary 4 | supplier-url4 |
        And Solutions exist
            | SolutionID | SolutionName    | OrganisationName | SupplierStatusId | SupplierId |
            | Sln1       | MedicOnline     | GPs-R-Us         | 1                | Sup 1      |
            | Sln2       | TakeTheRedPill  | Drs. Inc         | 1                | Sup 2      |
            | Sln3       | PracticeMgr     | Drs. Inc         | 1                | Sup 2      |
            | Sln4       | AnotherSolution | Drs. Inc         | 1                | Sup 2      |
    ...
    Scenario: 1. About supplier section presented where description and link exists
        ...
        And the solution about-supplier section contains description of Supplier summary 4
        And the solution about-supplier section contains link of supplier-url4

    @3653
    Scenario: 2. About supplier section presented where description exists
        When a GET request is made for solution preview Sln3
        Then a successful response is returned
        And the solution about-supplier section contains description of Supplier summary 3
        And the solution about-supplier section does not contain link

    @3653
    Scenario: 3. About supplier section presented where link exists
        When a GET request is made for solution preview Sln2
        Then a successful response is returned
        And the solution about-supplier section contains link of supplier-url2
        And the solution about-supplier section does not contain description
    ...
    Scenario: 4. About supplier section not presented where no about supplier exists
        ...
        Then a successful response is returned
        And the solution about-supplier section does not exist
