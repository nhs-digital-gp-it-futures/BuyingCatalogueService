...
@3681
Scenario: 2. A Status that does not exist is added
	When a PUT request is made to update a epics section for solution Sln1
		| EpicId | StatusName |
		| Epic1  | Unknown    |
	Then a response status of 400 is returned
...
@3681
Scenario: 4. Duplicate EpicIds are added
	When a PUT request is made to update a epics section for solution Sln2
		| EpicId | StatusName    |
		| Epic1  | Passed        |
		| Epic2  | Passed        |
...
@3681
Scenario: 5. Duplicate EpicIds are added & An EpicId & StatusName does not exist
	When a PUT request is made to update a epics section for solution Sln2
		| EpicId | StatusName    |
		| Epic1  | Passed        |
		| Epic2  | Passed        |
