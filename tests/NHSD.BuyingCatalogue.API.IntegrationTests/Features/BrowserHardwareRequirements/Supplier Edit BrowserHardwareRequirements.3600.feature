...
Scenario: 1. Browser Hardware Requirements is updated
    ...
    When a PUT request is made to update solution Sln1 browser-hardware-requirements section
        | HardwareRequirements |
        | New Hardware         |
    Then a successful response is returned
    And SolutionDetail exist
        | Solution | SummaryDescription             | FullDescription   | ClientApplication                                                                                                                                                                                                                                                                                        |
        | Sln1     | An full online medicine system | Online medicine 1 | { "ClientApplicationTypes": ["browser-based"],"BrowsersSupported" : [ "IE8", "Opera" ], "MobileResponsive": false, "Plugins": null, "MinimumConnectionSpeed": null, "MinimumDesktopResolution": null, "HardwareRequirements": "New Hardware", "AdditionalInformation": null, "MobileFirstDesign": null } |

@3600
Scenario: 2. Solution is not found
    Given a Solution Sln2 does not exist
    When a PUT request is made to update solution Sln2 browser-hardware-requirements section
       | HardwareRequirements      |
