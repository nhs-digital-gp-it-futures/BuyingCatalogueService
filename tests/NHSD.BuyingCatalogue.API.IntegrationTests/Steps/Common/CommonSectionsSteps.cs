...
namespace NHSD.BuyingCatalogue.API.IntegrationTests.Steps.Common
{
    ...
    internal sealed class CommonSectionsSteps
    {
        ...
        [Then(@"the solution (features|solution-description|client-application-types|contact-details|public-cloud|private-cloud|hosting-type-hybrid) section status is (COMPLETE|INCOMPLETE)")]
        ...
        [Then(@"the solution (features|solution-description|client-application-types|contact-details|public-cloud|private-cloud|hosting-type-hybrid) section requirement is (Mandatory|Optional)")]
