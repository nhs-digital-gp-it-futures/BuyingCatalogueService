...
namespace NHSD.BuyingCatalogue.API.IntegrationTests.Steps.Common
{
    ...
    internal sealed class CommonSectionsSteps
    {
        ...
        [Then(@"the solution (features|solution-description|client-application-types|contact-details|public-cloud|private-cloud) section status is (COMPLETE|INCOMPLETE)")]
        ...
        [Then(@"the solution (features|solution-description|client-application-types|contact-details|public-cloud|private-cloud) section requirement is (Mandatory|Optional)")]
