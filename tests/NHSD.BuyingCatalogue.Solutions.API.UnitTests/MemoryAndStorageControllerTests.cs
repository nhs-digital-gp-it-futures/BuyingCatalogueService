...
namespace NHSD.BuyingCatalogue.Solutions.API.UnitTests
{
    ...
    public sealed class MemoryAndStorageControllerTests
    {
        ...
        public async Task ShouldUpdateValidationInvalid()
        {
            ...
            (result?.Value as UpdateMobileMemoryAndStorageResult)?.Required.Should().BeEquivalentTo(new[] { "minimum-memory-requirement", "storage-requirements-description" });
            (result?.Value as UpdateMobileMemoryAndStorageResult)?.MaxLength.Should().BeEquivalentTo(new[] { "storage-requirements-description" });
