...
namespace NHSD.BuyingCatalogue.Solutions.Application.UnitTests.Solutions.NativeDesktop
{
    ...
    internal sealed class UpdateNativeDesktopHardwareRequirementsTests : ClientApplicationTestsBase
    {
        ...
        {
            var clientApplication = new ClientApplication { NativeDesktopHardwareRequirements = "initialHardwareRequirements" };
        ...
        {
            var command = new UpdateNativeDesktopHardwareRequirementsCommand("Sln1", "    hardware    ");
